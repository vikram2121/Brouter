...
# Optional: ANVIL_SPV_ENABLED=true  — activates Anvil as primary SPV source (requires Anvil v1.0.1+)
...
| 4 — Anvil + x402 | ✅ | Oracle mesh, x402 payment gate, SPV verification (Anvil v1.0.1 — on-demand BEEF, `arc+woc-fallback`) |
